	...
	<Menu bind:visibilityState={openMenu}>
		<div class="flex flex-col gap-4">
			<div class="flex flex-col">
				...
				<span class="text-zinc-50 text-sm sm:text-base mb-2"
			...
			<SignOut>
				<div
					slot="submitButton"
					class="w-[232px] rounded-md border-2 border-green-600 text-green-600 px-2 py-1 hover:border-green-500 hover:text-green-500"
				>
					Log Out
				</div>
			</SignOut>
